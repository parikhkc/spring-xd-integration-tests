...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% "-Dintegration.test.home=%APP_HOME%" "-Dlog4j.configuration=file:///%APP_HOME%/config/shelltest-logger.properties" -classpath "%CLASSPATH%" org.springframework.xd.itest.shell.IntegrationTest %CMD_LINE_ARGS%
